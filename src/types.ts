...
export type ScheduleCategory = '대출·원금' | '임대·보증금' | '세금' | '가족' | '여행·기타';
export type ScheduleStatus = 'in_progress' | 'extended' | 'completed';
...
export interface ScheduleEvent {
  ...
  dDay?: string; // e.g., 'D-3'
  completed?: boolean;
  completedAt?: string; // e.g., '2026.08.04'
  status?: ScheduleStatus; // e.g., 'in_progress' | 'extended' | 'completed'
